  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        ...
        <span className="ml-2 text-muted-foreground">Loading course requests...</span>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold">Course Information Requests</h1>
          <p className="text-muted-foreground">
            Manage and respond to course information requests.
          </p>
        </div>
      </div>
                  ...
                  <TableBody>
                    {filteredRequests.map((request) => (
                      <TableRow key={request.id}>
                        ...
                        <TableCell className="max-w-[180px] truncate">
                          {request.courseId ? (
                            <span>{getCourseTitle(request.courseId)}</span>
                          ) : (
                  ...
                  <CardContent className="space-y-3">
                    <div>
                      ...
                      {selectedRequest.courseId ? (
                        <p>{getCourseTitle(selectedRequest.courseId)}</p>
                      ) : (
                        <p>General inquiry</p>
                      )}
                    </div>
